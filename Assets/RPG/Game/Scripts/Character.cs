...
namespace RPG
{
    public class Character : MonoBehaviour, Targetable
    {
        ...
        public delegate void Converse(Character character, Character other, List<Conversation> conversations);
        ...
        public event Converse OnConversation;
        ...
        public void Talk(Character character, List<Conversation> conversations)
        {
            OnConversation?.Invoke(this, character, conversations);
        }
